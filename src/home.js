...
const InterestForm = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 z-50 flex items-center justify-between w-full px-6 py-3 shadow-md bg-white/30 md:px-12 lg:px-16 backdrop-blur-lg">  {/* bg-white/30*/} 
        <Link to={"/"}>
          <img
        ...
        <div>
          ...
          <div className="flex items-start gap-2 text-xs leading-5 text-gray-400">
            ...
            <p>
              ...
              M R R Estate, Survey No. 26,<br />
              Opposite CPRI, CPRI Road,<br />
              Medpalli, Hyderabad,<br />
      ...
      <div className="grid items-center grid-cols-1 gap-12 mx-auto max-w-7xl md:grid-cols-2">
        ...
        <div className="text-gray-800">
          ...
          <div className="space-y-5 text-[17px] leading-relaxed">
            <p>
              <strong>Neon Motors Pvt Ltd</strong> was incorporated in April 2013 as an authorized dealer for Mahindra & Mahindra. We expanded to Hyderabad in 2015 and now have 500+ dedicated employees.
            </p>
            <p>
              We're proudly associated with Hyundai, running a full-fledged 3S (Sales, Service, Spares) facility in the heart of Hyderabad at S.P. Road, Begumpet.
            </p>
            <p>
              As a trusted Hyundai dealer, we provide new and used car sales, financing, accessories, and after-sales service with transparency and excellence.
            </p>
            <p className="italic font-semibold text-blue-600">We look forward to serving you!</p>
          </div>
        </div>
